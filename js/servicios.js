...
/*serv 1*/
      ...
      $("#serv_11").html("<div class='hover-bg' id='serv_111'>");
       ...
       $("#serv_1_fin").html("<h4>DEPILACION</h4>");
...
/*serv 2*/
      ...
      $("#serv_21").html("<div class='hover-bg' id='serv_211'>");
       ...
       $("#serv_2_fin").html("<h4>CUIDADO CORPORAL</h4>");
...
/*serv 3*/
      ...
      $("#serv_31").html("<div class='hover-bg' id='serv_311'>");
       ...
       $("#serv_3_fin").html("<h4>CUIDADO FACIAL</h4>");
...
/*serv 4*/
      ...
      $("#serv_41").html("<div class='hover-bg' id='serv_411'>");
       ...
       $("#serv_4_fin").html("<h4>PRODUCTOS COSMETICA</h4>");
/*serv 5*/
